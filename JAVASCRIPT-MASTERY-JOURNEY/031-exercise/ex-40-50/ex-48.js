console.log(
  `48. Программуа, которая заполняет массив заданного размера случайными буквами и находит частоту встречаемости каждой буквы в массиве.`
);
console.log(`function generateRandomLetters(length) {
